...
# Modern, akıcı ve mobil uyumlu premium arayüz tasarımı
BASE_HTML = """
<!DOCTYPE html>
<html lang="tr">
<head>
...
def register():
    ...
    <div class="card">
        ...
        <p style="font-size:14px; text-align:center;">Zaten hesabın var mı? <a href="/login" style="color:#38bdf8;">Giriş Yap</a></p>
    </div>
    """
...
def login():
    ...
    <div class="card">
        ...
        <p style="font-size:14px; text-align:center;">Hesabın yok mu? <a href="/register" style="color:#38bdf8;">Kayıt Ol</a></p>
    </div>
    """
    return render_page(content)
    ...
    if request.method == "POST":
        ...
        if action == "text":
            ...
            if soru != "":
                ...
                # Eğer istek JavaScript fetch ile geldiyse JSON dönüyoruz (Sayfa yenilenmiyor!)
        ...
        # GÖRSEL ANALİZİ (Doğru OpenAI API Standardına Güncellendi)
            ...
            if uploaded_file and uploaded_file.filename != "":
                try:
                    ...
                    # Doğru gpt-4o-mini Vision entegrasyonu
                    response = client.chat.completions.create(
                        model="gpt-4o-mini",
                        messages=[
                            {
        ...
        <div class="main">
            ...
            <div class="bottom">
                ...
                <form class="image-bar" method="post" enctype="multipart/form-data">
                    ...
                    <input type="file" name="image" accept="image/*" required style="color:white; font-size:12px;">
                    <input type="text" name="image_prompt" placeholder="Resim sorusu..." style="background:#1e293b; border:none; padding:5px; color:white; border-radius:5px;">
